...
class SearchGiaovien extends User
{
    ...
    {
        return [
            [['_id', 'username', 'password_hash', 'password_reset_token', 'email', 'auth_key', 'role', 'status', 'created_at', 'updated_at', 'hoten', 'diachi', 'noicongtac', 'monday', 'hocvi', 'gioitinh', 'fb', 'gioithieu', 'anh', 'ngaysinh'], 'safe'],
        ];
    }
